...
public class MediaUtil {
   ...
   */
  public static BitmapDrawable getBitmapDrawable(ComponentContainer container, String mediaPath) throws IOException {
    ...
    try {
      options = getBitmapOptions(container, is1, mediaPath);
    } finally {
      is1.close();
    }
