...
public abstract class YaContextEditor extends SimpleEditor implements ComponentDatabaseChangeListener{
  ...
  final protected EditorType editorType;
  ...
  protected YaContextEditor(ProjectEditor projectEditor, FileNode fileNode, EditorType editorType) {
  ...
  public boolean isFormEditor() {
    return (this.editorType == EditorType.FORM);
  }

  public boolean isTaskEditor() {
    return (this.editorType == EditorType.TASK);
  }
