...
public class DesignToolbar extends Toolbar {
  ...
  private void doSwitchContext1(long projectId, String contextName, View view) {
    ...
    currentView = view;
    if (isScreen) {
      Context screen = currentProject.screens.get(newContextName);
      ...
      BlocklyPanel.setProjectLastForm(projectId, newContextName);
      ...
      Context task = currentProject.tasks.get(newContextName);
    ...
    // Inform the Blockly Panel which project/screen we are working on
